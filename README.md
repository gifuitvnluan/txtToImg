...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/txttoimg
```

A live public deployment of this template is available at [https://txttoimg.templates.workers.dev](https://txttoimg.templates.workers.dev)
